...
const ProductPage = () => {
  ...
  const addToCart = useCartStore((state) => state.addToCart); // Get cart function
  ...
  return (
    <div className="container mx-auto p-4">
      <div className="flex flex-col md:flex-row gap-8">
        <img src={product.image} alt={product.title} className="w-64 h-64 object-cover rounded-lg shadow-md" />
        <div>
